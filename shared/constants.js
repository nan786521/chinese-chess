...
export const AI_DIFFICULTY = {
    beginner: { depth: 2, quiesceDepth: 1, randomness: 150, label: '入門' },
    easy:     { depth: 3, quiesceDepth: 3, randomness: 30,  label: '初級' },
    medium:   { depth: 4, quiesceDepth: 4, randomness: 0,   label: '中級' },
    hard:     { depth: 5, quiesceDepth: 5, randomness: 0,   label: '高級' },
    master:   { depth: 6, quiesceDepth: 6, randomness: 0,   label: '大師' }
};
